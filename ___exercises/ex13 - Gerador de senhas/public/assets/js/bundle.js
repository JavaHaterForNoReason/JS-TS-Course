...
/* harmony export */ });
var geraSenha = function geraSenha() {
  var button = document.getElementById("generator-button");
  button.addEventListener("click", function () {
    var qtty = document.getElementById("char-qtty");
    var checkInputs = document.querySelectorAll(".input");
    var passLength = Number(qtty.value);
    if (passLength <= 0) {
    ...
    checkInputs.forEach(function (checkInput) {
      var checkbox = checkInput.querySelector("input");
      if (checkbox.checked) {
        var id = checkbox.id;
        switch (id) {
          case "num":
    ...
    var password = generatePass(charset.join(""), passLength);
    setMsg(password, "success");
  });
};
var setMsg = function setMsg(msg) {
  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "error";
  var result = document.querySelector(".result");
  var span = result.querySelector("span");
  var copyBtn = result.querySelector("button");
  span.className = "";
  span.classList.add(status);
  if (msg) {
    var aux = msg > 30 ? msg.slice(0, 30) + "..." : msg;
...
var copyText = function copyText(text) {
  navigator.clipboard.writeText(text).then(function () {
    return setMsg("Senha copiada", "success");
  })["catch"](function (e) {
    setMsg("Erro ao copiar");
    console.error(e);
  });
};
var generatePass = function generatePass(charset, length) {
  var password = "";
...
:is(.generator, .result) button:hover {
  padding: 9px;
  background-color: #fff;
...
`, "",{"version":3,"sources":["webpack://./src/assets/css/styles.css"],"names":[],"mappings":"AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,sBAAsB;EACtB,SAAS;EACT,UAAU;EACV,kCAAkC;EAClC,aAAa;AACf;;AAEA;EACE,aAAa;EACb,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,sCAAsC;AACxC;;AAEA;EACE,UAAU;EACV,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,sBAAsB;EACtB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,aAAa;EACb,sCAAsC;EACtC,WAAW;EACX,YAAY;EACZ,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,sBAAsB;EACtB,2BAA2B;EAC3B,sCAAsC;AACxC;;AAEA;;EAEE,aAAa;EACb,SAAS;AACX;;AAEA;EACE,6BAA6B;EAC7B,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,cAAc;AAChB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,WAAW;EACX,kBAAkB;AACpB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,cAAc;AAChB","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap\");\r\n\r\n:root {\r\n  --primary-color: #865fb7eb;\r\n}\r\n\r\n* {\r\n  box-sizing: border-box;\r\n  margin: 0;\r\n  padding: 0;\r\n  font-family: \"Poppins\", sans-serif;\r\n  outline: none;\r\n}\r\n\r\nbody {\r\n  height: 100vh;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  background-color: var(--primary-color);\r\n}\r\n\r\n.container {\r\n  width: 30%;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 10px;\r\n  background-color: #fff;\r\n  padding: 30px;\r\n  border-radius: 15px;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n.container h1 {\r\n  font-size: 20px;\r\n}\r\n\r\n.container ul {\r\n  margin: 10px 0 0 10px;\r\n  font-size: 14px;\r\n}\r\n\r\n.generator {\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 10px;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n:is(.generator, .result) button {\r\n  width: 100%;\r\n  padding: 10px;\r\n  background-color: var(--primary-color);\r\n  color: #fff;\r\n  border: none;\r\n  border-radius: 10px;\r\n  cursor: pointer;\r\n}\r\n\r\n:is(.generator, .result) button:hover {\r\n  padding: 9px;\r\n  background-color: #fff;\r\n  color: var(--primary-color);\r\n  border: 1px solid var(--primary-color);\r\n}\r\n\r\n.input,\r\n.qttty {\r\n  display: flex;\r\n  gap: 10px;\r\n}\r\n\r\n.qtty {\r\n  border-bottom: 1px solid #bbb;\r\n  padding-bottom: 5px;\r\n}\r\n\r\n.qtty input {\r\n  width: 30%;\r\n  font-size: 1em;\r\n}\r\n\r\n.options {\r\n  width: 100%;\r\n}\r\n\r\n.result {\r\n  display: none;\r\n  width: 100%;\r\n  text-align: center;\r\n}\r\n\r\n.result button {\r\n  width: 50%;\r\n}\r\n\r\n.result .error {\r\n  color: red;\r\n}\r\n\r\n.result .success {\r\n  color: #008000;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
(function () {
  (0,_modules_geraSenha__WEBPACK_IMPORTED_MODULE_2__["default"])();
})();
})();
